        ...
        <div class="col-lg-12">
            ...
            <form action="{{ route('parcel.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                            ...
                            <div class="row g-gs">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <div>
                                        <select name="merchant"
                                            ...
                                            <option value="{{ @$parcel->merchant->id }}" {{ @$parcel->merchant->id !=
                                                null ? 'selected' : '' }}>
                                                {{ @$parcel->merchant->user->first_name . ' ' .
                                                @$parcel->merchant->user->last_name }} ({{ @$parcel->merchant->company
                                                }})
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <select
                                        ...
                                        data-url="{{ route('admin.merchant.shop') }}" id="merchant_select" name="shop">
                                        @isset($parcel)
                                ...
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="customer_name">{{ __('customer') . ' ' . __('name')
                                ...
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="customer_phone_number">{{ __('customer') . ' ' .
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        name="customer_invoice_no" id="customer_invoice_no"
                                ...
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="selling_price">{{ __('selling_price') }} ({{
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" min="1" name="total_quantity" id="total_quantity"
                                        class="form-control" value="{{ old('total_quantity', 1) }}"
                                        placeholder="{{ __('total_quantity') }}">
                                </div>

                                <!-- Row 4: District & Thana -->
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="city_to_thana">{{ __('district') }} / District <span
                                            class="text-danger">*</span></label>
                                    <select
                                        ...
                                        <option value="{{ $district->id }}"
                                            data-name="{{ strtolower($district->name) }}" {{ old('city_id', @$parcel->
                                            district_id ?? @$parcel->city_id) == $district->id ? 'selected' : '' }}>
                                            {{ $district->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="thana_to_area">Thana <span
                                            class="text-danger">*</span></label>
                                    <select style="width:100%"
                                        ...
                                        <option value="{{ $thana->id }}" {{ old('thana_id', @$parcel->thana_id) ==
                                            $thana->id ? 'selected' : '' }}>
                                            {{ $thana->name }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="delivery_area">{{ __('delivery_area') }} <span
                                            class="text-danger">*</span></label>
                                    <select
                                        ...
                                        <option value="same_day" {{ old('parcel_type')=='same_day' ? 'selected' :
                                            (@$parcel->parcel_type == 'same_day' ? 'selected' : '') }}>
                                            {{ __('same_day') }}
                                        </option>
                                        @endif
                                        @if (settingHelper('preferences')->where('title', 'sub_city')->first()->staff)
                                        <option value="sub_city" {{ old('parcel_type')=='sub_city' ? 'selected' :
                                            (@$parcel->parcel_type == 'sub_city' ? 'selected' : '') }}>
                                            {{ __('sub_city') }}
                                        </option>
                                        @endif
                                        @if (settingHelper('preferences')->where('title',
                                        'sub_urban_area')->first()->staff)
                                        <option value="outside_city" {{ old('parcel_type')=='outside_city' ? 'selected'
                                            : (@$parcel->parcel_type == 'sub_urban_area' ? 'selected' : '') }}>
                                            {{ __('sub_urban_area') }}
                                        </option>
                                        @endif
                                    </select>
                                ...
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="weight">{{ __('weight') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="number"
                                        class="form-control weight @error('weight') is-invalid @enderror" name="weight"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <select class="without_search form-select form-control packaging" name="packaging"
                                        ...
                                        <option value="{{ $package_and_charge->id }}" {{ isset($parcel) ? ($parcel->
                                            packaging == $package_and_charge->id ? 'selected' : '') : '' }}>
                                ...
                                <!-- Row 7: Customer Address & Note (Both Textareas with exact same rows="3" height!) -->
                                <div class="col-6 mb-3">
                                    <label class="form-label" for="customer_address">{{ __('customer') . ' ' .
                                    ...
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div id="address_auto_detect_badge"
                                        class="badge bg-soft-success text-success mt-2 p-1 px-2 d-none"
                                        style="font-size: 13px; border: 1px solid #28a745; border-radius: 4px; display: inline-block;">
                                ...
                                <div class="col-12 mt-2">
                                    <div class="form-check mb-2">
                                        <input type="checkbox" class="form-check-input" id="transfer_to_branch"
                                            value="1" name="transfer_to_branch" {{ old('transfer_to_branch') ? 'checked'
                                            : '' }}>
                                        <label class="form-check-label text-capitalize" for="transfer_to_branch"
                                            style="cursor: pointer;">
                                            {{ __('transfer_to_branch') }}
                                        </label>
                                    </div>

                                    <div class="col-6 mb-3 px-0 {{ old('transfer_to_branch') ? '' : 'd-none' }}"
                                        id="transfer_branch_wrapper">
                                        <label class="form-label" for="destination_branch_id">{{ __('select_branch') }}
                                            <span class="text-danger">*</span></label>
                                        <select
                                            class="without_search form-select form-control @error('destination_branch_id') is-invalid @enderror"
                                            name="destination_branch_id" id="destination_branch_id">
                                            <option value="" selected disabled>{{ __('select_branch') }}</option>
                                            @foreach ($branch as $item)
                                            <option value="{{ $item->id }}" {{ (old('destination_branch_id')==$item->id
                                                || old('transfer_branch_select_id') == $item->id) ? 'selected' : '' }}>
                                                {{ $item->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-check mb-2">
                                        <input type="checkbox" class="form-check-input" id="open_box" value="1"
                                            name="open_box" {{ old('open_box') ? 'checked' : '' }}>
                                        <label class="form-check-label text-capitalize" for="open_box"
                                            style="cursor: pointer;">
                                            {{ __('open_box') }}
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check mb-3">
                                        <input type="checkbox" class="form-check-input" id="home_delivery"
                                            name="home_delivery" value="1" checked>
                                        <label class="form-check-label text-capitalize" for="home_delivery"
                                            style="cursor: pointer;">
                                            {{ __('home_delivery') }}
                                        </label>
                                    </div>
                    ...
                    <!-- Right Column: Charges & Pickup Details -->
                    <div class="col-md-4">
                        <div class="card bg-white redious-border p-20 p-sm-30 pt-sm-30">
                            ...
                            <div class="card-inner p-0">
                                <table class="table">
                                    <tr>
                                        <th><span><strong>{{ __('title') }}</strong></span></th>
                                        <th class="text-right"><span><strong>{{ __('amount') }}</strong></span></th>
                                    </tr>
                                    <tr>
                                        <td><span>{{ __('cash_collection') }}</span></td>
                                        <td class="text-right">
                                            <span id="cash-collection-charge">{{ isset($parcel) ? $parcel->price :
                                                '0.00' }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><span>{{ __('delivery_charge') }}</span></td>
                                        <td class="text-right">
                                            <span id="delivery-charge">{{ isset($parcel) ? $parcel->charge : '0.00'
                                                }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><span>{{ __('cod_charge') }}</span></td>
                                        <td class="text-right">
                                            <span id="cod-charge">{{ isset($parcel) ? format_price(($parcel->price /
                                                100) * $parcel->cod_charge) : '0.00' }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><span>{{ __('vat') }}</span></td>
                                        <td class="text-right">
                                            <span id="vat-charge">{{ isset($parcel) ? format_price((($parcel->charge +
                                                $parcel->fragile_charge + $parcel->packaging_charge + ($parcel->price /
                                                100) * $parcel->cod_charge) / 100) * $parcel->vat) : '0.00' }}</span>
                                        </td>
                                    </tr>
                                    {{-- <tr
                                        class="fragile-charge-area {{ isset($parcel) ? ($parcel->fragile == 0 ? 'd-none' : '') : 'd-none' }}">
                                        <td><span>{{ __('liquid') }}/{{ __('fragile_charge') }}</span></td>
                                        <td class="text-right">
                                            <span id="fragile-charge">{{ isset($parcel) ? ($parcel->fragile == 0 ?
                                                '0.00' : $parcel->fragile_charge) : '0.00' }}</span>
                                        </td>
                                    </tr> --}}
                                    <tr
                                        class="packaging-charge-area {{ isset($parcel) ? ($parcel->packaging == 'no' ? 'd-none' : '') : 'd-none' }}">
                                        <td><span>{{ __('packaging_charge') }}</span></td>
                                        <td class="text-right">
                                            <span id="packaging-charge">{{ isset($parcel) ? ($parcel->packaging == 'no'
                                                ? '0.00' : $parcel->packaging_charge) : '0.00' }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><span>{{ __('total_delivery_charge') }}</span></td>
                                        <td class="text-right">
                                            <span id="total-delivery-charge">{{ isset($parcel) ?
                                                format_price($parcel->total_delivery_charge) : '0.00' }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><span><strong>{{ __('current_payable') }}</strong></span></td>
                                        <td class="text-right">
                                            <span>
                                                <strong id="current-payable-charge">
                                                    <div id="currency"
                                                        data-default-currency="{{ setting('default_currency') }}"></div>
                                                    {{ isset($parcel) ? (setting('default_currency') . $parcel->payable)
                        ...
                        <div class="card bg-white redious-border p-20 p-sm-30 pt-sm-30 mt-4">
                            <div class="card-title-group mb-2">
                                <div class="card-title">
                                    <h6 class="title">{{ __('pickup_details') ?? 'Pickup Details' }}</h6>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="shop_pickup_branch">{{ __('pickup_branch') }} <span
                                        class="text-danger">*</span></label>
