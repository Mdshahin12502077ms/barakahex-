                    ...
                    <div class="row">
                            ...
                            <div class="card bg-white redious-border p-20 p-sm-30 pt-sm-30">
                                <div class="row g-gs">
                                    ...
                                    <div class="col-6 mb-3">
                                        <label class="form-label">{{ __('merchant') }} <span class="text-danger">*</span></label>
                                        <div>
                                            <select name="merchant"
                                                ...
                                                <option value="{{ @$parcel->merchant->id }}" {{ @$parcel->merchant->id != null ? 'selected' : '' }}>
                                                    {{ @$parcel->merchant->user->first_name . ' ' . @$parcel->merchant->user->last_name }} ({{ @$parcel->merchant->company }})
                                                </option>
                                            </select>
                                        </div>
                                        @error('merchant')
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        @if ($errors->has('shop'))
                                            <div class="invalid-feedback help-block"><p>{{ $errors->first('shop') }}</p></div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('customer_name') is-invalid @enderror"
                                            ...
                                            name="customer_name" id="customer_name" placeholder="{{ __('recipient_name') }}">
                                        @error('customer_name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('customer_phone_number') is-invalid @enderror"
                                            ...
                                            name="customer_phone_number" id="customer_phone_number" placeholder="{{ __('recipient') . ' ' . __('phone') }}">
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('customer_invoice_no') is-invalid @enderror"
                                            ...
                                            name="customer_invoice_no" id="customer_invoice_no" placeholder="{{ __('invoice_or_memo_no') }}">
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="number" class="form-control cash-collection @error('price') is-invalid @enderror"
                                            id="fv-full-name" value="{{ old('price') != '' ? old('price') : @$parcel->price }}"
                                            name="price" placeholder="{{ __('cash_amount_including_delivery_charge') }}">
                                        @error('price')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="number" class="form-control weight @error('weight') is-invalid @enderror"
                                            name="weight" id="weight" min="0" step="0.01"
                                            value="{{ old('weight') != '' ? old('weight') : (@$parcel->weight ?? 0) }}"
                                            placeholder="{{ __('weight') }}">
                                        @if ($errors->has('weight'))
                                            <div class="invalid-feedback help-block"><p>{{ $errors->first('weight') }}</p></div>
                                        @endif
                                    </div>
                                        ...
                                        <select class="without_search form-select form-control packaging" name="packaging" id="packaging">
                                            ...
                                            @foreach (settingHelper('package_and_charges') as $package_and_charge)
                                                <option value="{{ $package_and_charge->id }}" {{ isset($parcel) ? ($parcel->packaging == $package_and_charge->id ? 'selected' : '') : '' }}>
                                                    {{ __($package_and_charge->package_type) }} ({{ format_price($package_and_charge->charge) }})
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        @if ($errors->has('note'))
                                            <div class="invalid-feedback help-block"><p>{{ $errors->first('note') }}</p></div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-12 mt-2">
                                        ...
                                        <div class="col-6 mb-3 px-0 {{ old('transfer_to_branch') ? '' : 'd-none' }}" id="transfer_branch_wrapper">
                                            ...
                                            @if ($errors->has('destination_branch_id'))
                                                <div class="invalid-feedback help-block"><p>{{ $errors->first('destination_branch_id') }}</p></div>
                                            @endif
                                        </div>

                                        <div class="form-check mb-2">
                                            <input type="checkbox" class="form-check-input" id="open_box" value="1" name="open_box"
                                                {{ old('open_box') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="card-inner p-0">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <span id="cod-charge">{{ isset($parcel) ? format_price(($parcel->price / 100) * $parcel->cod_charge) : '0.00' }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><span>{{ __('vat') }}</span></td>
                                            <td class="text-right">
                                                <span id="vat-charge">{{ isset($parcel) ? format_price((($parcel->charge + $parcel->fragile_charge + $parcel->packaging_charge + ($parcel->price / 100) * $parcel->cod_charge) / 100) * $parcel->vat) : '0.00' }}</span>
                                            </td>
                                        </tr>
                                        <tr class="fragile-charge-area {{ isset($parcel) ? ($parcel->fragile == 0 ? 'd-none' : '') : 'd-none' }}">
                                        ...
                                        <tr class="packaging-charge-area {{ isset($parcel) ? ($parcel->packaging == 'no' ? 'd-none' : '') : 'd-none' }}">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <span id="total-delivery-charge">{{ isset($parcel) ? format_price($parcel->total_delivery_charge) : '0.00' }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="card bg-white redious-border p-20 p-sm-30 pt-sm-30 mt-4">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="shop_pickup_branch">{{ __('pickup_branch') }} <span class="text-danger">*</span></label>
                                    ...
                                    @if ($errors->has('pickup_branch_id'))
                                        <div class="invalid-feedback help-block"><p>{{ $errors->first('pickup_branch_id') }}</p></div>
                                    @endif
                                </div>
                                <div class="mb-3">
                                    ...
                                    @if ($errors->has('shop_phone_number'))
                                        <div class="invalid-feedback help-block"><p>{{ $errors->first('shop_phone_number') }}</p></div>
                                    @endif
                                </div>
                                <div class="mb-3">
