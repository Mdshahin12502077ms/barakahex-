                                ...
                                <div class="card-inner">
                                                ...
                                                <select class="without_search form-control" id="branch"
                                                    ...
                                                    @foreach ($branchs as $branch)
                                                        <option value="{{ $branch->id }}">
                                                            {{ $branch->name . (!empty($branch->type) ? ' [' . ucfirst(str_replace('_', ' ', $branch->type)) . ']' : '') . ' (' . $branch->address . ')' }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right mt-4">
                                            <div class="">
                                                <button type="submit"
                                                    class="btn sg-btn-primary d-md-inline-flex resubmit">{{ __('print_and_save') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
