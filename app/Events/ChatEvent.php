    ...
    public function broadcastWith()
    {
        return [
            'message' => [
                ...
                'replies_staff_id' => $this->chat->replies_staff_id,
                'conversation_id' => $this->chat->conversation_id,
                'sender_image'    => $this->chat->sender ? $this->chat->sender->getUserImage() : null,
                'sender_name'     => $this->chat->sender ? $this->chat->sender->name: null,
                'receiver_name'   => $this->chat->receiver ? $this->chat->receiver->name: null,
